...
- [Tests] move `0.6` to allowed failures, because it wonâ€˜t build on travis [`1bff32a`](https://github.com/inspect-js/object-inspect/commit/1bff32aa52e8aea687f0856b28ba754b3e43ebf7)
...
- [Fix] `inspect(Object(-0))` should be â€œObject(-0)â€, not â€œObject(0)â€ [`d0a031f`](https://github.com/inspect-js/object-inspect/commit/d0a031f1cbb3024ee9982bfe364dd18a7e4d1bd3)
...
- [Tests] up to `node` `v8.6`; use `nvm install-latest-npm` to ensure new npm doesnâ€™t break old node [`252952d`](https://github.com/inspect-js/object-inspect/commit/252952d230d8065851dd3d4d5fe8398aae068529)
