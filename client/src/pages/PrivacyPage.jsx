...
function simpleMarkdownToHtml(md){ return md.split("\n\n").map(block=>{ if(block.startsWith("# ")) return "<h1>"+block.replace("# ","")+"</h1>"; if(block.startsWith("## ")) return "<h2>"+block.replace("## ","")+"</h2>"; return "<p>"+block.replace("\n","<br/>")+"</p>"; }).join("") }
